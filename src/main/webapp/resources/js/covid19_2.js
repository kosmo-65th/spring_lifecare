...
/*
 *  �꾩쟻 寃��ъ닔 = �꾩쟻 寃��ъ셿猷뚯닔(寃곌낵�묒꽦 + 寃곌낵�뚯꽦) + 寃��ъ쭊�됱쨷
 *  �꾩쟻 �뺤쭊瑜� = (寃곌낵�묒꽦 / �꾩쟻 寃��ъ셿猷뚯닔) * 100
 *  �꾩쟻 �뺤쭊�섏옄��(寃곌낵�묒꽦) = 移섎즺以� �섏옄 + �꾩튂(寃⑸━�댁젣) + �щ쭩��
 */

/*
 *  寃��ы쁽��(Inspect Status : IS) - 寃��ъ쭊�됱쨷(inspect), 寃곌낵�묒꽦(positive), 寃곌낵�뚯꽦(negative)
 *  Chart - Donut : label, figure, bgColor, total
 */
var IS_data = {};
//var IS_data = {
//    label: ['寃곌낵�뚯꽦', '寃��ъ쨷', '寃곌낵�묒꽦'],
...
/*
 *  二쇨컙�섏옄�숉뼢(Weekly Patient Status : WPS) - 移섎즺以�(cure), �꾩튂(complete), �щ쭩(die)
 *  Chart - Bar + Line
 */
var WPS_data = {};
//var WPS_data = {
...
/*
 *  援��蹂� �뺤쭊�섏옄 異붿꽭(National Patient Trend) - ���쒕�援�(Korea), 以묎뎅(China), �댄깉由ъ븘(Italy), �대�(Iran), �ㅽ럹��(Spain), �꾨옉��(France), �낆씪(Germany), 誘멸뎅(America), �ㅼ쐞��(Switzerland), �곴뎅(UK)
 *  Chart - Line
 */
...
function NPTChart() {
    new Chart(document.getElementById('national_patient_trend'), {
        type: 'bar', // bar ���낆쓣 �ｌ뼱�� Line Point媛� 以묒븰�뺣젹 �쒕떎.
        data: {
...
/*
 *  吏���퀎�뺤쭊�섏옄�꾪뼢(Regional Patient Status : RPS) - 吏���챸(name), 吏���퀎 �뺤쭊�섏옄(patient), 吏���퀎 �꾩씪��鍮�(compare)
 *  Chart - Map
 */
...
/*
 *  吏���컻�앸퉬��(Regional Incidence Ratio : RIR) - 珥� �뺤쭊�섏옄(total), 吏��� �뺤쭊�섏옄(patient)
 *  Chart - Donut Gauge
 */
...
/*
 *  吏���퀎�뺤쭊�섏옄�꾪뼢(Regional Patient Status : RPS) - 吏���퀎 �뺤쭊�섏옄(patient)
...
/*
 *  吏���퀎�뺤쭊�섏옄鍮꾩쑉 A(Regional Patient Ratio A : RPR_A) - 吏���퀎 �뺤쭊�섏옄(patient) - 援щ텇 : ��援�, 寃쎈턿, �쒖슱, 寃쎄린, 湲고�
 *  Chart - Pie
 */
...
function RPRAMainChart() {
	...
	var status	=	wCatch(); //pc �쇰븣 label 2以� �뺣━
	if (status == 'p') {	
...
function RPRAChart() {
	...
	var status	=	wCatch(); //tablet �쇰븣 label 2以� �뺣━
	if (status == 't') {	
		RPR_A_data.label[0] += "\n"; //��援�		
		RPR_A_data.label[2] += "\n"; //�쒖슱
		RPR_A_data.label[3] += "\n"; //寃쎄린
...
/*
 *  吏���퀎�뺤쭊�섏옄鍮꾩쑉 B(Regional Patient Ratio B : RPR_B) - 吏���퀎 �뺤쭊�섏옄(patient) - 援щ텇 : ��援�, 寃쎈턿, 湲고�
 *  Chart - Donut
 */
var RPR_B_data = {};
//var RPR_B_data = {
//    label: ['��援�', '湲고�', '寃쎈턿', '�쒖슱', '寃쎄린'],
...
function RPRBChart() {
	...
	var status	=	wCatch(); //mobile �쇰븣 label 2以� �뺣━
	if (status == 'm') {
		RPR_B_data.label[0] += "\n"; //��援�
		RPR_B_data.label[2] += "\n"; //�쒖슱
		RPR_B_data.label[3] += "\n"; //寃쎄린
...
/*
 *  吏묐떒諛쒖깮鍮꾩쑉(Group Incidence Ratio : GIR) - 珥� �뺤쭊�섏옄(total), 吏묐떒蹂� �뺤쭊�섏옄(patient)
 *  Chart - Donut
 */
var GIR_data = {};
//var GIR_data = {
//    label: ['�좎쿇吏� 愿���', '湲고� 吏묐떒諛쒖깮', '�곕컻�� 諛쒖깮'],
...
/*
 *  �뺤쭊�섏옄異붿꽭(Patient Trend) - �꾩쟻(total), �쇱씪(daily)
 *  Chart - Bar + Line
 */
...
/*
 *  寃⑸━�댁젣異붿꽭(Complete Trend) - �꾩쟻(total), �쇱씪(daily)
 *  Chart - Bar + Line
 */
...
/*
 *  吏묐떒諛쒖깮鍮꾩쑉(Transmission Case : TC)
 *  Chart - Donut
 */
var TC_data = {};
//var TC_data = {
...
function TCChart() {
	...
	var status	=	wCatch(); //mobile �쇰븣 label 3以� �뺣━, padding�뺣━
	var padding_left,
	padding_right,
	padding_top,
	padding_bottom;
	
	if (status == 'm') { //mobile �쇰븣 padding媛� 議곗젅
		padding_left = '45';
		padding_right = '45';
		padding_top = '60';
		padding_bottom = '40';
                    ...
                    labels: {
                        inside: {
                            ...
                            offset: function(a, b) {
                            	...
                            	if (a.dataIndex === (a.dataset.data.length - 1)) { //留덉�留� 媛�
                            		if (status == 'm') { //mobile �쇰븣 �꾩튂媛� 議곗젅
                            			return 40;
                            		}else{
                            			return 30;
                            		}                            		
                            ...
                            formatter: function(a, b) {
                            	var a = Number(a);
                            	if (status == 'm') { //mobile �쇰븣 3以� 泥섎━
                            		if (b.dataIndex < 5){
                            			return b.chart.data.labels[b.dataIndex] + "\n" + a.toLocaleString() + "紐�\n(" + ((a * 100) / TC_total).toFixed(i) + ' %)';
                            		}else{
                            			return b.chart.data.labels[b.dataIndex] + "" + a.toLocaleString() + "紐� (" + ((a * 100) / TC_total).toFixed(i) + ' %)';
                            		}
                            	}else{                            		
                                	if (b.dataIndex < 5) {
                                		return b.chart.data.labels[b.dataIndex] + "\n" + a.toLocaleString() + "紐� (" + ((a * 100) / TC_total).toFixed(i) + ' %)';
                                	} else {
                                		return b.chart.data.labels[b.dataIndex] + " " + a.toLocaleString() + "紐� (" + ((a * 100) / TC_total).toFixed(i) + ' %)';
                                	}
                            	}                            	
...
var N_Data = {
    USA: { kr: "誘멸뎅", en: "USA", cn: "獰롥쎖", pointStyle: "triangle", borderDash: [0, 0], backgroundColor: "#ff12ff", pointColor: "#ff12ff", lineColor: "#ff12ff", fontColor: "#ff12ff" },
    Brazil: { kr: "釉뚮씪吏�", en: "Brazil", cn: "藥닺�", pointStyle: "rect", borderDash: [0, 0], backgroundColor: "#ffffff", pointColor: "#4f4f4f", lineColor: "#4f4f4f", fontColor: "#4f4f4f" },
    Russia: { kr: "�ъ떆��", en: "Russia", cn: "岳꾤퐮��", pointStyle: "rectRot", borderDash: [0, 0], backgroundColor: "#ffffff", pointColor: "#e92828", lineColor: "#e92828", fontColor: "#e92828" },
    UK: { kr: "�곴뎅", en: "UK", cn: "�긷쎖", pointStyle: "circle", borderDash: [2, 1], backgroundColor: "#ffffff", pointColor: "#15399e", lineColor: "#15399e", fontColor: "#15399e" },
    Spain: { kr: "�ㅽ럹��", en: "Spain", cn: "蜈욜룺��", pointStyle: "triangle", borderDash: [2, 1], backgroundColor: "#ffffff", pointColor: "#ff12ff", lineColor: "#ff12ff", fontColor: "#ff12ff" },
    Italy: { kr: "�댄깉由ъ븘", en: "Italy", cn: "�뤷ㄷ��", pointStyle: "rect", borderDash: [2, 1], backgroundColor: "#ffffff", pointColor: "#197b30", lineColor: "#197b30", fontColor: "#197b30" },
    India: { kr: "�몃룄", en: "India", cn: "�겼벧", pointStyle: "rectRot", borderDash: [2, 1], backgroundColor: "#ffffff", pointColor: "#0606ff", lineColor: "#0606ff", fontColor: "#0606ff" },
    Germany: { kr: "�낆씪", en: "Germany", cn: "孃룟쎖", pointStyle: "circle", borderDash: [0, 0], backgroundColor: "#ffffff", pointColor: "#721dca", lineColor: "#721dca", fontColor: "#721dca" },
    Peru: { kr: "�섎（", en: "Peru", cn: "燁섌쾪", pointStyle: "triangle", borderDash: [0, 0], backgroundColor: "#ffffff", pointColor: "#00b8ce", lineColor: "#00b8ce", fontColor: "#00b8ce" },
    Turkey: { kr: "�고궎", en: "Turkey", cn: "�잒�녑끀", pointStyle: "rect", borderDash: [0, 0], backgroundColor: "#4f4f4f", pointColor: "#4f4f4f", lineColor: "#4f4f4f", fontColor: "#4f4f4f" },
    Iran: { kr: "�대�", en: "Iran", cn: "鴉딀쐵", pointStyle: "rectRot", borderDash: [0, 0], backgroundColor: "#e92828", pointColor: "#e92828", lineColor: "#e92828", fontColor: "#e92828" },
    France: { kr: "�꾨옉��", en: "France", cn: "力뺝쎖", pointStyle: "circle", borderDash: [2, 1], backgroundColor: "#15399e", pointColor: "#15399e", lineColor: "#15399e", fontColor: "#15399e" }
};
