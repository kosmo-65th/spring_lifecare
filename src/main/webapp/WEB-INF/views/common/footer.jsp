...
<footer id="footer">
	<ul class="innerWrap footerLink2">
		<li><a href="${path}/guest/nonpayment" class="colorPoint04" target="_blank">비급여진료비용</a></li>
		<li><a href="${path}/guest/pbor" target="_blank">환자권리장전</a></li>
		<li><a href="${path}/guest/conditions" target="_blank">이용약관</a></li>
		<li><a href="${path}/guest/PI" class="colorPoint04" target="_blank">개인정보 처리방침</a></li>
		<li><a href="${path}/guest/OI" target="_blank">정보공개</a></li>
