     ...
     <form action="" method="post" name="findPassword">
        ...
        <div class="findPassword_area">
          <p>FORGOT YOUR PASSWORD?</p>                
             ...
             <input type="text" name="customer_email" id="" placeholder="이메일을 입력해주세요." class="mb10" value="" >
             <input type="text" name="customer_phone" id="" placeholder="전화번호를 입력해주세요" class="mb10" value="" >             
         </div>                                  
        <div class="press">
