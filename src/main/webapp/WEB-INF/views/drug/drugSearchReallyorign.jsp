		...
		<section id="search_identity">
			...
			<article class="search_table">
				...
				<table style="min-width: max-content;">
					<%-- <tr>
						...
						<td id="drug_namelist" class="idty_td5">
							<input type="text" id="drug_name" name="drug_name" value="" onkeyup="javascript:drugNmAjax()" onkeydown="searchEnter()" onfocus="this.value = this.value;"/>
					...
					<tr>
						<th>회사명</th>
						<td class="idty_td6">
							<input type="text" id="firm_name" name="firm_name" value="entp_name" onkeyup="javascript:upsoNmAjax()" onkeydown="searchEnter2()" onfocus="this.value = this.value;"/>
					...
					<tr>
						...
						<th>회사명</th>
						<td class="entp_name">
							<input type="text" id="entp_name" name="entp_name" value="" />
						</td>
					</tr>
				...
				<div id="btns">
					...
					<button type="submit" title="검색" name="searchDrug" class="search ico" id="btn_idfysearch" onclick="idfySend();">검 색</button>
				</div>
				</fieldset>
				</form>
			</article><!-- //검색테이블 -->
