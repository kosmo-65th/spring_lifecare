...
function getDrugName(val){
	...
	$.ajax({
		type:"GET",
		url:'http://apis.data.go.kr/1470000/MdcinGrnIdntfcInfoService/getMdcinGrnIdntfcInfoList?ServiceKey=58Rm0ocO44dWpDnMaulASGoUU%2BOw4nXiq6xj6%2F%2BSqqkWwKcGUmHOx%2FbSQyvv456ugnbmslYMMx%2FqHm5jGgqZiw%3D%3D&item_name='+encodeURIComponent($('#drug_name').val()),
		async:true,
		cache: false,
		dataType:"jsonp",
