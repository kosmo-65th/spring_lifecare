...
$(function(){
	$('#btn_idfysearch').click(function(){
		...
		window.location="android_drugSearchPro?drug_name=" + drug_name + "&drug_enptname="+drug_enptname+ "&drug_formulation="+formList + "&drug_color="+colorList+"&drug_shape=" +shapeList ; 
