                            ...
                            <div class="col-md-6">
                                <div class="form-group" style="margin-left:60px;">
                                    <label>예약가능 시간 설정</label>
                                      <input type='checkbox' name='appoint_time' value='09:00' id="time0"><span id="timeText0" style="margin-left:10px;">09:00</span>
                                      <input type='checkbox' name='appoint_time' value='11:00' id="time1"><span id="timeText1" style="margin-left:10px;">11:00</span>
									  <input type='checkbox' name='appoint_time' value='14:00' id="time2"><span id="timeText2" style="margin-left:10px;">14:00</span>
									  <input type='checkbox' name='appoint_time' value='16:00' id="time3"><span id="timeText3" style="margin-left:10px;">16:00</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" style="margin-left:60px;">
                                    <label>예약가능 시간 설정</label>
                                      <input type='checkbox' name='appoint_time' value='09:00' id="time4"/><span id="timeText4" style="margin-left:10px;">09:00</span>
                                      <input type='checkbox' name='appoint_time' value='11:00' id="time5"/><span id="timeText5" style="margin-left:10px;">11:00</span>
									  <input type='checkbox' name='appoint_time' value='14:00' id="time6"/><span id="timeText6" style="margin-left:10px;">14:00</span>
									  <input type='checkbox' name='appoint_time' value='16:00' id="time7"/><span id="timeText7" style="margin-left:10px;">16:00</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" style="margin-left:60px;">
                                    <label>예약가능 시간 설정</label>
                                      <input type='checkbox' name='appoint_time' value='09:00' id="time8"/><span id="timeText8" style="margin-left:10px;">09:00</span>
                                      <input type='checkbox' name='appoint_time' value='11:00' id="time9"/><span id="timeText9" style="margin-left:10px;">11:00</span>
									  <input type='checkbox' name='appoint_time' value='14:00' id="time10"/><span id="timeText10" style="margin-left:10px;">14:00</span>
									  <input type='checkbox' name='appoint_time' value='16:00' id="time11"/><span id="timeText11" style="margin-left:10px;">16:00</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" style="margin-left:60px;">
                                    <label>예약가능 시간 설정</label>
                                      <input type='checkbox' name='appoint_time' value='09:00' id="time12"/><span id="timeText12" style="margin-left:10px;">09:00</span>
                                      <input type='checkbox' name='appoint_time' value='11:00' id="time13"/><span id="timeText13" style="margin-left:10px;">11:00</span>
									  <input type='checkbox' name='appoint_time' value='14:00' id="time14"/><span id="timeText14" style="margin-left:10px;">14:00</span>
									  <input type='checkbox' name='appoint_time' value='16:00' id="time15"/><span id="timeText15" style="margin-left:10px;">16:00</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group" style="margin-left:60px;">
                                    <label>예약가능 시간 설정</label>
                                      <input type='checkbox' name='appoint_time' value='09:00' id="time16"/><span id="timeText16" style="margin-left:10px;">09:00</span>
                                      <input type='checkbox' name='appoint_time' value='11:00' id="time17"/><span id="timeText17" style="margin-left:10px;">11:00</span>
									  <input type='checkbox' name='appoint_time' value='14:00' id="time18"/><span id="timeText18" style="margin-left:10px;">14:00</span>
									  <input type='checkbox' name='appoint_time' value='16:00' id="time19"/><span id="timeText19" style="margin-left:10px;">16:00</span>
                                </div>
                            </div>
                        </div>
                        <div class="row">
