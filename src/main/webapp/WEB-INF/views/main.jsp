<%@ page language="java" contentType="text/html; charset=UTF-8"
   ...
   <body class="clinic_version">
               ...
               <div class="col-md-12 col-sm-12">
                  <div class="text-contant">
                     <h2>
                        ...
                        <a href="" class="typewrite" data-period="2000" data-type='[ "Welcome", "abcdefg", "asdfgghh" ]'>
      ...
      <div id="about" class="section wow fadeIn">
         <div class="container">
            <div class="heading">
               <span class="icon-logo"><img src="${path3}images/icon-logo.png" alt="#"></span>
            ...
            <div class="row">
               ...
               <div class="col-md-6">
                  <div class="post-media wow fadeIn">
                     <img src="${path3}images/about_03.jpg" alt="" class="img-responsive">
            ...
            <div class="row">
               <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="service-widget">
                     <div class="post-media wow fadeIn">
                        <a href="${path3}images/clinic_01.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="${path3}images/clinic_01.jpg" alt="" class="img-responsive">
                     </div>
               ...
               <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="service-widget">
                     <div class="post-media wow fadeIn">
                        <a href="${path3}images/clinic_02.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="${path3}images/clinic_02.jpg" alt="" class="img-responsive">
                     </div>
               ...
               <div class="col-md-3 col-sm-6 col-xs-12">
                  <div class="service-widget">
                     <div class="post-media wow fadeIn">
                        <a href="${path3}images/clinic_03.jpg" data-rel="prettyPhoto[gal]" class="hoverbutton global-radius"><i class="flaticon-unlink"></i></a>
                        <img src="${path3}images/clinic_03.jpg" alt="" class="img-responsive">
                     </div>
               ...
               <div class="col-lg-8 col-md-8 col-sm-6 col-xs-12">
                  <div class="inner-services">
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           <span class="icon-service"><img src="${path3}images/service-icon1.png" alt="#" /></span>
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           <span class="icon-service"><img src="${path3}images/service-icon2.png" alt="#" /></span>
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           <span class="icon-service"><img src="${path3}images/service-icon3.png" alt="#" /></span>
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           <span class="icon-service"><img src="${path3}images/service-icon4.png" alt="#" /></span>
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           <span class="icon-service"><img src="${path3}images/service-icon5.png" alt="#" /></span>
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12">
                        <div class="serv">
                           <span class="icon-service"><img src="${path3}images/service-icon6.png" alt="#" /></span>
            ...
            <div class="row dev-list text-center">
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.2s; animation-name: fadeIn;">
                    <div class="widget clearfix">
                        <img src="${path3}images/doctor_01.jpg" alt="" class="img-responsive img-rounded">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s" style="visibility: visible; animation-duration: 1s; animation-delay: 0.4s; animation-name: fadeIn;">
                    <div class="widget clearfix">
                        <img src="${path3}images/doctor_02.jpg" alt="" class="img-responsive img-rounded">
                        <div class="widget-title">
                            <h3>Bryan Saftler</h3>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 wow fadeIn">
                    <div class="widget clearfix">
                        <img src="${path3}images/doctor_03.jpg" alt="" class="img-responsive img-rounded">
                        <div class="widget-title">
	  ...
	  <div id="price" class="section pr wow fadeIn" style="background-image:url('${path3}images/price-bg.png');">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
            ...
            <div class="row">
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                  <div class="testimonial clearfix">
                     ...
                     <div class="testi-meta">
                        <img src="${path3}images/testi_01.png" alt="" class="img-responsive alignleft">
               ...
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.4s">
                  <div class="testimonial clearfix">
                     ...
                     <div class="testi-meta">
                        <img src="${path3}images/testi_02.png" alt="" class="img-responsive alignleft">
            ...
            <div class="row">
               <div class="col-md-6 col-sm-12 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.6s">
                  <div class="testimonial clearfix">
                     ...
                     <div class="testi-meta">
                        <img src="${path3}images/testi_03.png" alt="" class="img-responsive alignleft">
