...
<tbody>
  ...
  <tr>
    ...
    <td class="tg-9pky" colspan="4">${dto.customer_name}</td>
    ...
    <td class="tg-9pky" colspan="8">LifeCare</td>
  </tr>
  <tr>
    ...
    <td class="tg-9pky" colspan="8">010-7220-7446</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td class="tg-dvpl" colspan="4" rowspan="2"><br><br><br><span style = "font-size : 32px">${dto.doctor_name}</span> <img src="${path_resources}images/lifecaresign.png" width="80px" height="80px" style = "align:center; z-index:1;"/></td>
